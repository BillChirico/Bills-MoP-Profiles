-- Quest Information
BANETO_DefineProfileName("Golden_Lotus_06_Given_a_Second_Chance")
...
BANETO_SetNextLocalQuestProfile([[Golden_Lotus_07_Striking_First]])
...
function _G.BANETO_ExecuteCustomQuestPulse()
    if not BANETO_HasQuest(30312) then
        ...
        BANETO_LoadQuestProfile([[Golden_Lotus_07_Striking_First]])
        return
    end
