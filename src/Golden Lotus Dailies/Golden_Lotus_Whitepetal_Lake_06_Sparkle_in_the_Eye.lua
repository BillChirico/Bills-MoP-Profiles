-- Quest Information
BANETO_DefineProfileName("Golden_Lotus_Whitepetal_Lake_06_Sparkle_in_the_Eye")
BANETO_DefineProfileType("Questing")
BANETO_SetToSkipTurnInQuest()
BANETO_DefineQuestStepType([[GatherObject]])
BANETO_DefineQuestId(30265)

-- Quest Objective
BANETO_DefineQuestTargetId(212760) -- Ruby Eye
...
-- Next Quest in Chain
BANETO_SetNextLocalQuestProfile([[Golden_Lotus_Whitepetal_Lake_07_The_Displaced_Paleblade]])
...
function _G.BANETO_ExecuteCustomQuestPulse()
    ...
    if not BANETO_HasQuest(30265) then
        ...
        BANETO_LoadQuestProfile([[Golden_Lotus_Whitepetal_Lake_07_The_Displaced_Paleblade]])
        return
    end
